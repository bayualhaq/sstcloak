...
#sst1 (Wegare)
clear
udp2="$(cat /root/akun/sst1.txt | grep -i udp | cut -d= -f2)" 
host2="$(cat /root/akun/sst1.txt | grep -i host | cut -d= -f2 | head -n1)" 
port2="$(cat /root/akun/sst1.txt | grep -i port | cut -d= -f2)" 
bug2="$(cat /root/akun/sst1.txt | grep -i bug | cut -d= -f2)" 
pass2="$(cat /root/akun/sst1.txt | grep -i pass | cut -d= -f2)" 
enc2="$(cat /root/akun/sst1.txt | grep -i enc | cut -d= -f2)" 
uid2="$(cat /root/akun/sst1.txt | grep -i uid | cut -d: -f2)" 
publickey2="$(cat /root/akun/sst1.txt | grep -i publickey | cut -d: -f2)" 
plugin2="$(cat /root/akun/sst1.txt | grep -i plugin | cut -d= -f2)" 
obfs2="$(cat /root/akun/sst1.txt | grep -i obfs | cut -d= -f2 | tail -n1)" 
...
plugin=$plugin
obfs=$obfs
udp=$udp" > /root/akun/sst1.txt

cat <<EOF> /usr/bin/gproxy-sst1
...
udp="$(cat /root/akun/sst1.txt | grep -i udp | cut -d= -f2)" 
host="$(cat /root/akun/sst1.txt | grep -i host | cut -d= -f2 | head -n1)" 
route="$(cat /root/akun/ipmodem.txt | grep -i ipmodem | cut -d= -f2 | tail -n1)" 

ss-local -c /root/akun/sst1.json &
sleep 3
...
EOF
chmod +x /usr/bin/ping-sst1
/usr/bin/ping-sst1 > /dev/null 2>&1 &
elif [ "${tools}" = "3" ]; then
host="$(cat /root/akun/sst1.txt | grep -i host | cut -d= -f2 | head -n1)" 
route="$(cat /root/akun/ipmodem.txt | grep -i ipmodem | cut -d= -f2 | tail -n1)" 
#killall screen
killall -q badvpn-tun2socks ss-local ping-sst1
...
sed -i "/^# BEGIN AUTOREKONEKsst1/,/^# END AUTOREKONEKsst1/d" /etc/crontabs/root > /dev/null
/etc/init.d/cron restart
